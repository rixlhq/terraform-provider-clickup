...
var manualDataSourceFactories = []func() datasource.DataSource{
	...
	newRawJSONDataSource("task_time_in_status", "/v2/task/{task_id}/time_in_status", []string{"task_id"},
		rawQueryParam{name: "custom_task_ids"},
		rawQueryParam{name: "team_id"},
	),
	newRawJSONDataSource("bulk_time_in_status", "/v2/task/bulk_time_in_status", nil,
